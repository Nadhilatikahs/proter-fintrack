<x-filament::page>
    {{-- TITLE + WELCOME (fades out after 3 seconds) --}}
    <div class="ft-page-subtitle ft-welcome-message" id="welcome-message">
    ...
    <div class="ft-dashboard-toolbar">
        <div class="ft-date-range">
            ...
            <input type="date" wire:model.live="fromDate" class="ft-input-date" />
            <span class="ft-label">to</span>
            <input type="date" wire:model.live="toDate" class="ft-input-date" />
        </div>

        <a href="{{ \App\Filament\Resources\TransactionResource::getUrl('create') }}" class="ft-btn-outline-green">
    ...
    <div class="ft-card ft-card-light ft-last-transactions">
        <div class="ft-last-header">
            ...
            <a href="{{ \App\Filament\Resources\TransactionResource::getUrl('index') }}" class="text-sm underline"
